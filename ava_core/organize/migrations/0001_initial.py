    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_group_data', models.CharField(blank=True, max_length=10000, null=True)),
                ('ldap_group_data', models.CharField(blank=True, max_length=10000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier_type', models.CharField(choices=[('EMAIL', 'Email Address'), ('SKYPE', 'Skype ID'), ('IPADD', 'IP Address'), ('UNAME', 'Username'), ('TWITTER', 'Twitter ID'), ('NAME', 'Other name'), ('GOOGLE_ID', 'Google ID'), ('OFFICE_ID', 'Office ID'), ('GUID', 'Guid'), ('SID', 'Sid')], default='EMAIL', max_length=10, verbose_name='Identifier Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('google_identity_data', models.CharField(blank=True, max_length=10000, null=True, verbose_name='Google Data')),
                ('ldap_identity_data', models.CharField(blank=True, max_length=10000, null=True, verbose_name='LDAP Data')),
                ('office365_identity_data', models.CharField(blank=True, max_length=10000, null=True, verbose_name='Office365 Data')),
