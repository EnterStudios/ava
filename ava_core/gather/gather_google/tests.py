...
class GoogleGatherHistoryTest(AvaCoreTest):
    # step 2: replace appName and GoogleGatherHistory
    model_name = 'gather_google.GoogleGatherHistory'
    ...
    api_urls = {
        'create': 'googlegatherhistory-list',
        'retrieve': 'googlegatherhistory-detail',
        'retrieve_all': 'googlegatherhistory-list',
        'update': 'googlegatherhistory-detail',
        'delete': 'googlegatherhistory-detail',
    }
    ...
    def create_object_via_api(self, data, user='admin'):
        ...
        url = reverse("google-setup-list")
        integration = GoogleIntegrationAdapterTestData()
    ...
    # step 7: replace googlegatherhistory globally with your model name in lowercase
    def test_googlegatherhistory_create_as_user(self):
        self.create_object_via_api(data=self.data.standard, user='standard')

    def test_googlegatherhistory_create_as_admin(self):
        self.create_object_via_api(data=self.data.standard, user='admin')

    def test_googlegatherhistory_create_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard, user=None)

    def test_googlegatherhistory_retrieve_single_as_user(self):
    ...
    def test_googlegatherhistory_retrieve_all_as_user(self):
    ...
    def test_googlegatherhistory_retrieve_single_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_retrieve_all_as_admin(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_retrieve_single_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_retrieve_all_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_update_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_update_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_googlegatherhistory_update_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_update_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_googlegatherhistory_update_exists_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_update_does_not_exist_as_unauthenticated(self):
        self.logout_user()
    ...
    def test_googlegatherhistory_delete_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_googlegatherhistory_delete_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_delete_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_delete_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_googlegatherhistory_delete_exists_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googlegatherhistory_delete_does_not_exist_as_unauthenticated(self):
        self.logout_user()
