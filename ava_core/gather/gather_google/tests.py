...
class GoogleGatherHistoryTest(AvaCoreTest):
    ...
    # TODO:    Write retrieve owner tests    def test_google_gather_history_update_exists_as_user(self):
        # Create new GoogleGatherHistory models, storing URL.
        url = self.create_model_logout(self.data, data_name='standard', owner=self.user_user)
        # Log in as user.
        self.login_user(self.user_user)
    ...
    # TODO:    Write update owner tests    def test_google_gather_history_delete_exists_as_user(self):
        # Create new GoogleGatherHistory models, storing URL.
        url = self.create_model_logout(self.data, data_name='standard', owner=self.user_user)
        # Log in as user.
        self.login_user(self.user_user)
