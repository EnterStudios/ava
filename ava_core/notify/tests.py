...
class NotificationEmailTest(AvaCoreTest):
    # step 2: replace notify and NotificationEmail
    model_name = 'notify.NotificationEmail'
    ...
    api_urls = {
        'create': 'notificationemail-list',
        'retrieve': 'notificationemail-detail',
        'retrieve_all': 'notificationemail-list',
        'update': 'notificationemail-detail',
        'delete': 'notificationemail-detail',
    }
    ...
    # step 7: replace notificationemail globally with your model name in lowercase
    def test_notificationemail_create_as_user(self):
        url = reverse(self.api_urls['create'])
    ...
    def test_notificationemail_create_as_admin(self):
        url = reverse(self.api_urls['create'])
        data = self.data.standard
    ...
    def test_notificationemail_create_as_unauthenticated(self):
        url = reverse(self.api_urls['create'])
        data = self.data.standard
    ...
    def test_notificationemail_retrieve_single_as_user(self):
    ...
    def test_notificationemail_retrieve_all_as_user(self):
    ...
    def test_notificationemail_retrieve_single_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_retrieve_all_as_admin(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_retrieve_single_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_retrieve_all_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_update_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_update_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_notificationemail_update_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_update_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_notificationemail_update_exists_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_update_does_not_exist_as_unauthenticated(self):
        self.logout_user()
    ...
    def test_notificationemail_delete_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_notificationemail_delete_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_delete_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_delete_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_notificationemail_delete_exists_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_notificationemail_delete_does_not_exist_as_unauthenticated(self):
        self.logout_user()
