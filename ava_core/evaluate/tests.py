...
class EvaluateResultTest(AvaCoreTest):
    ...
    def create_object_via_api(self, data, user='admin'):
        test = EvaluateTestTest()
        test.setUp()
        target_profile_id = test.create_object_via_api(data=EvaluateTestTestData.standard)

        data['target_profile'] = target_profile_id
        print("data :: " + str(data))

        return super(EvaluateResultTest, self).create_object_via_api(data=data, user=user)
...
class EvaluateControllerTest(AvaCoreTest):
    ...
    def create_object_via_api(self, data, user='admin'):
        ...
        # create the sender
        url = reverse("evaluatesender-list")
        integration = EvaluateSenderTestData()
        ...
        if 'id' in response.data:
            data['sender'] = response.data['id']

         # create the sender
        url = reverse("evaluatetemplate-list")
        integration = EvaluateTemplateTestData()
        ...
        # return the id of the model you are testing
        if 'id' in response.data:
            data['template'] = response.data['id']

        return super(EvaluateControllerTest, self).create_object_via_api(data=data,user=user)
    ...
    def test_evaluatecontroller_update_exists_as_admin(self):
        ...
        url = reverse(self.api_urls['update'], kwargs={'pk': object_id})
        self.data.standard['name'] = self.data.unique['name']
        response = self.client.put(url, self.data.standard, format='json')
...
class EvaluateTestTest(AvaCoreTest):
    ...
    def create_object_via_api(self, data, user='admin'):
        ...
        controller = EvaluateControllerTest()
        controller.setUp()
        controller_id =  controller.create_object_via_api(data=EvaluateControllerTestData.standard)
        print("controller :: " + str(controller_id))
        data['controller'] = controller_id

        # create the sender
        url = reverse("person-list")
        integration = PersonTestData()
        ...
        # return the id of the model you are testing
        if 'id' in response.data:
            data['target'] = response.data['id']

        return super(EvaluateTestTest, self).create_object_via_api(data=data, user=user)
