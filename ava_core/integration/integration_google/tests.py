...
class GoogleIntegrationAdapterTest(AvaCoreTest):
    # step 2: replace appName and GoogleIntegrationAdapter
    ...
    api_urls = {
        'create': 'google-setup-list',
        'retrieve': 'google-setup-detail',
        'retrieve_all': 'google-setup-list',
        'update': 'google-setup-detail',
        'delete': 'google-setup-detail',
    }
    ...
    # step 7: replace googleintegrationadapter globally with your model name in lowercase
    def test_googleintegrationadapter_create_as_user(self):
        url = reverse(self.api_urls['create'])
    ...
    def test_googleintegrationadapter_create_as_admin(self):
        url = reverse(self.api_urls['create'])
        data = self.data.standard
    ...
    def test_googleintegrationadapter_create_as_unauthenticated(self):
        url = reverse(self.api_urls['create'])
        data = self.data.standard
    ...
    def test_googleintegrationadapter_retrieve_single_as_user(self):
    ...
    def test_googleintegrationadapter_retrieve_all_as_user(self):
    ...
    def test_googleintegrationadapter_retrieve_single_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_retrieve_all_as_admin(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_retrieve_single_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_retrieve_all_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_update_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_update_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_googleintegrationadapter_update_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_update_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_googleintegrationadapter_update_exists_as_unauthenticated(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_update_does_not_exist_as_unauthenticated(self):
        self.logout_user()
    ...
    def test_googleintegrationadapter_delete_does_not_exist_as_user(self):
        self.login_user(user="standard")
    ...
    def test_googleintegrationadapter_delete_exists_as_user(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_delete_exists_as_admin(self):
        object_id = self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_delete_does_not_exist_as_admin(self):
        self.login_user(user="admin")
    ...
    def test_googleintegrationadapter_delete_exists_as_unauthenticated(self):
        self.create_object_via_api(data=self.data.standard)
    ...
    def test_googleintegrationadapter_delete_does_not_exist_as_unauthenticated(self):
        self.logout_user()
