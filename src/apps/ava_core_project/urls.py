...
urlpatterns = patterns('',
    ...
    url(r'^(?P<pk>\d+)/teams/(?P<team>\d+)/$', project_access_required(ProjectAccess.MODIFY, views.ProjectTeams.as_view()), name='project-teams'),
    url(r'^(?P<pk>\d+)/teams/add/$', project_access_required(ProjectAccess.MODIFY, views.ProjectTeamsAdd.as_view()), name='project-teams-add'),
    ...
    url(r'^(?P<pk>\d+)/identifiers/add/$', project_access_required(ProjectAccess.MODIFY, views.ProjectIdentifiersAdd.as_view()), name='project-identifiers-add'),
    url(r'^(?P<pk>\d+)/identities/remove/(?:(?P<ident>\d+)/)?$', project_access_required(ProjectAccess.MODIFY, views.ProjectIdentifiersRemove.as_view()), name='project-identifiers-remove'),
)
