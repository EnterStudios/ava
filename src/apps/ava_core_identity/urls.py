...
urlpatterns = patterns('',
    ...
    url(r'^identity/(?P<pk>\d+)/update/$', system_admin_required(views.IdentityUpdate.as_view()), name='identity-update'),
    url(r'^identity/(?P<pk>\d+)/delete/$', system_admin_required(views.IdentityDelete.as_view()), name='identity-delete'),
