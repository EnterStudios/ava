...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Identifier.identifiertype'
        db.alter_column(u'ava_core_people_identifier', 'identifiertype', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'Identifier.identifiertype'
        db.alter_column(u'ava_core_people_identifier', 'identifiertype', self.gf('django.db.models.fields.CharField')(max_length=5))
