...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.project'
        db.delete_column(u'ava_core_people_person', 'project_id')

        # Adding field 'Person.organisation'
        db.add_column(u'ava_core_people_person', 'organisation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_core_org.Organisation']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Person.project'
        db.add_column(u'ava_core_people_person', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_core_org.Organisation']),
                      keep_default=False)

        # Deleting field 'Person.organisation'
        db.delete_column(u'ava_core_people_person', 'organisation_id')
