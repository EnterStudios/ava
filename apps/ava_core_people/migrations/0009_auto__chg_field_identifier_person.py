...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ava_core_people_identifier', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_people.Person'], null=True))

    def backwards(self, orm):

        # Changing field 'Identifier.person'
        db.alter_column(u'ava_core_people_identifier', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['ava_core_people.Person']))
