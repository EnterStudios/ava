...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.identity'
        db.add_column(u'ava_core_people_person', 'identity',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'ava_core_people_extendedprofile', (
            ...
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ava_core_people.Person'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'ava_core_people', ['ExtendedProfile'])

        # Deleting field 'Person.identity'
        db.delete_column(u'ava_core_people_person', 'identity_id')
