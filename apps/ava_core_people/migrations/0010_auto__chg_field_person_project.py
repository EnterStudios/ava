...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.project'
        db.alter_column(u'ava_core_people_person', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_org.Organisation']))

    def backwards(self, orm):

        # Changing field 'Person.project'
        db.alter_column(u'ava_core_people_person', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ava_core_project.Project']))
    ...
    models = {
        ...
        u'ava_core_people.person': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ava_core_org.Organisation']"}),
